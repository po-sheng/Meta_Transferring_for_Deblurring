    ...
    def __getitem__(self, idx):
        ...
        # Get sharpest patch among all frames
            ...
            for i in range(self.args.n_frames//2, len(self.blur_list)-(self.args.n_frames//2)):
                ...
                diff = self_shift(img[H:H + self.args.support_size, W:W + self.args.support_size, :])
...
class TestSet(Dataset):
    def __init__(self, args):
        ...
        if self.args.meta_train:
            ...
            self.transform = transforms.Compose([Resize(self.args.input_h, self.args.input_w, 4), Normalize(args.centralized, args.normalized), ToTensor()])
